...
export const book1Detail: BookDetailT = {
  ...
  reviews: [
    ...
    },
    {
      rating: 4.0,
      review_raw:
        "Objectively it took me 4 days to read this but subjectively it felt like 20 minutes, did not expect it to be so funny and fun, I especially appreciate the way it ends, I'm really excited to see where the series goes after this!“You don't blame humans for what you were forced to do? For what happened to you?” This is why I'm glad I'm not human. They come up with stuff like this. I said, “No. That's a human thing to do. Constructs aren't that stupid.”",
